...
int mm_check_opt(const mm_idxopt_t *io, mm_mapopt_t *mo);
 ...
 */
mm_reg1_t *mm_map(const mm_idx_t *mi, int l_seq, const char *seq, int *n_regs, mm_tbuf_t *b, mm_mapopt_t *opt, const char *name);
